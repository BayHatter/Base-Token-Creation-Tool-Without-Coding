...
const BaseAssetWithNoSSR = dynamic(() => import('../assets/BaseAsset'), {
  ssr: false,
});
        ...
        {({ provider, account, connectWallet, disconnectWallet }) => (
          <>
            ...
            <Head>
              ...
              <meta property="og:description" content="Build and deploy a meme coin instantly on Base. Fast, secure, and 100% code-free." />
            ...
            <div className="container mx-auto p-4 max-w-7xl flex flex-col md:flex-row gap-4">
              <div className="flex-1">
                <BaseAssetWithNoSSR provider={provider} account={account} connectWallet={connectWallet} />
              </div>
